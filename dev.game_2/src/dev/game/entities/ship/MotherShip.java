...
public abstract class MotherShip extends Entity {
    ...
    public MotherShip(EntityManager entitymanager, Handler handler, float x, float y, int width, int height,ID id) {
